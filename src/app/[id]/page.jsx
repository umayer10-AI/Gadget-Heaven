...
const page = async ({params}) => {
    ...
    return (
        <div>
            <div className='bg-[#9538E2] rounded-2xl text-center pt-10 pb-65 space-y-3 relative mb-80'>
            ...
            <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-3 bg-black/50 shadow-2xl backdrop-blur-xl absolute -bottom-15 left-1/2 -translate-x-1/2 gap-6 p-5 rounded-2xl'>
                <div>
                ...
                <div className='space-y-2 col-span-2'>
                    ...
                    <div className='flex items-center gap-3'>
                        <button className='btn btn-primary rounded-full'>Add To Card <FaCartPlus /></button>
